...
OVERVIEW
--------
1. <b>image.py</b> has three features that operate independently: First, it can add a text watermark to all images in a directory. Second, it can create black-and-white copies of all images in a directory. Third, it can shrink all images in a directory by an amount you specify. This is the inspiration for the program--shrinking large camera images for easy emailing. 
