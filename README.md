...
- First, it can add a text watermark to all images in a directory (see Figures 1 and 2). 
- Second, it can create black-and-white copies of all images in a directory (see Figure 3). 
- Third, it can shrink all images in a directory by an amount you specify (see Figure 4). (Emailing smaller files was the inspiration for the  program.) 
